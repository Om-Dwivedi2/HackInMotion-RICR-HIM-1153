...
const TargetRoleCard = ({ role, company, resumeName, lastAnalyzed }) => {
    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex-1 min-w-[350px]">
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          {company && <p className="text-sm font-medium text-slate-600">{company}</p>}
        </div>
      ...
      <div className="flex gap-3">
        ...
        <button 
          ...
          className="flex-1 py-2.5 px-4 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors text-sm"
        >
          Change Target
        </button>
      </div>
